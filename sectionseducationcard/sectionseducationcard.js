...
function educationcardCtrl($mdDialog, $http, datagenerate, $rootScope) {
    ...
    ctrl.schools = [];
    ctrl.colleges = [];
    $http.get('http://localhost:8080/education/' + ctrl.candidateid).then(function(
        response) {
    ...
    $rootScope.$on("datachanged", function() {
        ...
        $http.get('http://localhost:8080/education/' + ctrl.candidateid).then(
            function(response) {
    ...
    function dialogCtrl($scope, $mdDialog, $http, header, object, $rootScope) {
        ...
        $scope.save = function(header) {
            ...
            if (header == ("Add Education")) {
                $http({
                        method: 'POST',
                        url: 'http://localhost:8080/education/' + ctrl.candidateid,
